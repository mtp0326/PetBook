 ...
 */
export declare type ConfigurationDefinition<Configuration extends {
    [key: string]: any;
}, ResolvedConfiguration extends Configuration> = {
    readonly [P in keyof Configuration]: ConfigurationPropertyDefinition<Configuration[P], ResolvedConfiguration[P], Configuration, ResolvedConfiguration>;
};
/**
