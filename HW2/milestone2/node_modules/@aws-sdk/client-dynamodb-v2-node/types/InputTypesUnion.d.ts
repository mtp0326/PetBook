...
export declare type InputTypesUnion = BatchGetItemInput | BatchWriteItemInput | CreateBackupInput | CreateGlobalTableInput | CreateTableInput | DeleteBackupInput | DeleteItemInput | DeleteTableInput | DescribeBackupInput | DescribeContinuousBackupsInput | DescribeEndpointsInput | DescribeGlobalTableInput | DescribeGlobalTableSettingsInput | DescribeLimitsInput | DescribeTableInput | DescribeTimeToLiveInput | GetItemInput | ListBackupsInput | ListGlobalTablesInput | ListTablesInput | ListTagsOfResourceInput | PutItemInput | QueryInput | RestoreTableFromBackupInput | RestoreTableToPointInTimeInput | ScanInput | TagResourceInput | UntagResourceInput | UpdateContinuousBackupsInput | UpdateGlobalTableInput | UpdateGlobalTableSettingsInput | UpdateItemInput | UpdateTableInput | UpdateTimeToLiveInput;
