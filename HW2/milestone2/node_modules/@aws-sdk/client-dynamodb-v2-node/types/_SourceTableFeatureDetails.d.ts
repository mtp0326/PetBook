import { _LocalSecondaryIndexInfo, _UnmarshalledLocalSecondaryIndexInfo } from './_LocalSecondaryIndexInfo';
import { _GlobalSecondaryIndexInfo, _UnmarshalledGlobalSecondaryIndexInfo } from './_GlobalSecondaryIndexInfo';
import { _StreamSpecification, _UnmarshalledStreamSpecification } from './_StreamSpecification';
import { _TimeToLiveDescription, _UnmarshalledTimeToLiveDescription } from './_TimeToLiveDescription';
...
export interface _UnmarshalledSourceTableFeatureDetails extends _SourceTableFeatureDetails {
    /**
     * <p>Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. </p>
     */
