...
export interface SerializeHandlerArguments<Input extends object, Stream = Uint8Array> extends HandlerArguments<Input> {
    /**
...
export interface FinalizeHandlerArguments<Input extends object, Stream = Uint8Array> extends HandlerArguments<Input> {
    /**
     * The user input serialized as an HTTP request.
     */
    request: HttpRequest<Stream>;
}
export interface BuildHandlerArguments<Input extends object, Stream = Uint8Array> extends FinalizeHandlerArguments<Input, Stream> {
}
...
export interface SerializeHandler<Input extends object, Output extends object, Stream = Uint8Array> {
    /**
     * Asynchronously converts an input object into an output object.
     *
     * @param args  An object containing a input to the command as well as any
...
export interface FinalizeHandler<Input extends object, Output extends object, Stream = Uint8Array> {
    /**
     * Asynchronously converts an input object into an output object.
     *
     * @param args  An object containing a input to the command as well as any
...
export interface BuildHandler<Input extends object, Output extends object, Stream = Uint8Array> extends FinalizeHandler<Input, Output, Stream> {
}
/**
...
export interface Middleware<Input extends object, Output extends object> {
     ...
     */
    (next: Handler<Input, Output>, context: HandlerExecutionContext): Handler<Input, Output>;
}
/**
 * A factory function that creates functions implementing the {BuildHandler}
 * interface.
 */
export interface SerializeMiddleware<Input extends object, Output extends object, Stream = Uint8Array> {
    /**
     * @param next The handler to invoke after this middleware has operated on
     * the user input and before this middleware operates on the output.
     *
     * @param context Invariant data and functions for use by the handler.
     */
    (next: SerializeHandler<Input, Output, Stream>, context: HandlerExecutionContext): SerializeHandler<Input, Output, Stream>;
}
/**
 * A factory function that creates functions implementing the {FinalizeHandler}
 * interface.
 */
export interface FinalizeMiddleware<Input extends object, Output extends object, Stream = Uint8Array> {
    /**
     * @param next The handler to invoke after this middleware has operated on
     * the user input and before this middleware operates on the output.
     *
     * @param context Invariant data and functions for use by the handler.
     */
    (next: FinalizeHandler<Input, Output, Stream>, context: HandlerExecutionContext): FinalizeHandler<Input, Output, Stream>;
}
export interface BuildMiddleware<Input extends object, Output extends object, Stream = Uint8Array> extends FinalizeMiddleware<Input, Output, Stream> {
}
/**
 * A factory function that creates the terminal handler atop which a middleware
 * stack sits.
 */
export interface Terminalware<OutputConstraint extends object, Stream = Uint8Array> {
    <Input extends object, Output extends OutputConstraint>(context: HandlerExecutionContext): FinalizeHandler<Input, Output, Stream>;
}
...
export interface MiddlewareStack<Input extends object, Output extends object, Stream = Uint8Array> {
    /**
